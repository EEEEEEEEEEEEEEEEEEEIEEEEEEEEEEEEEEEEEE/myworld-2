jQuery.extend(jQuery.validator.messages, {
    ...
    isCodeValue:"只能由字母、数字或-组成",
    isZipCode:"请正确填写您的邮政编码",
    isPhoneValue:"请输入正确的电话号码",
    length: "字符长度只能是 {0} 的字符串"
});
 ...
 * 验证是字母, 数字或-
 */
jQuery.validator.addMethod("isCodeValue", function (value, element) {
    var length = value.length;
...
//验证电话号码
jQuery.validator.addMethod("isPhoneValue", function (value, element) {
    var length = value.length;
